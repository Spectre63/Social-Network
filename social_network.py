...
class Graph: #Abdullah, a graph class to represent the network
    ...
    def remove_member(self, member): #A method to remove members
    ...
    def get_member_friends(self, member): # Get all friends of a member
        return self.members[member.name].get_adjacent()
    
    def find_mutual_friends(self, member1, member2): # Al yaman, Find mutual friends between two members
    ...
    def recommend_friends(self, member): # Al Yaman, Recommend friends based on mutual connections
...
# print(graph.get_member_friends(p1))
>>>>>>> b65941ac460b73e9929ee5e4a21ffc83b0af9676
